                    ...
                    <div class="table-container shadow1">
                        <div class="login-page">
                            <div class="form">
                                ...
                                <?php
                                echo $this->Form->create(null, ['url' => ['controller' => 'users', 'action' => 'updatePortfolio'], 'autocomplete' => 'off', 'class' => 'login-form', 'id' => 'e_frm']);
                                echo $this->Form->hidden('stock_id',['value'=>$data->id]);
                                ?>
